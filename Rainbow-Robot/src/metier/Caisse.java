...
public class Caisse implements Dessinable, Serializable {
     ...
     * en fusionnant les couleurs autorisées. Une fusion représente le mélange
     * de deux couleurs (intersection L/C de la matrice). Lorqu'une fusion est
     * impossible l'intersection de ces deux couleurs vaut 0. JAUNE + ROUGE =
    ...
    public static Caisse fusionCouleur(Caisse c1, Caisse c2) {
        ...
        if (c1.getCouleur() != 0 && c2.getCouleur() != 0) {
            ...
            if (isFusionOk(c1.getCouleur(), c2.getCouleur())) {
                ...
                c3.setCouleur(FUSION_COULEUR[c1.getCouleur() - 1][c2
                        .getCouleur() - 1]);

                // La caisse résultat de la fusion prend la position de c2
                c3.setPosCaisse(new Position(c2.getPosCaisse().getX(), c2
                        .getPosCaisse().getY()));
            }
        }
        return c3;
    ...
    /**
     * Vérifie si une couleur peut être dessinée.
     * 
     * @param aVerifier
     *            couleur a vérifiée
     ...
     * 
     * @param couleur
     *            le caractère correpondant à une caisse
