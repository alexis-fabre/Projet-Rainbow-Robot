...
/**
 * Classe gérant les caisses présentent sur la carte et dans les commandes 
 * que devra effectuer le joueur via le robot
...
public class Caisse implements Dessinable{
     ...
     * @param couleur la couleur de la caisse à sa création
     */
     ...
     * la carte
     * @param couleur la couleur de la caisse
     * @param p_initial position intiale de la caisse sur la carte
     */
     ...
     * fusion de caisse
     * @param c1 première caisse à fusionner tenue par le robot
     * @param c2 deuxième caisse à fusionner
     ...
     * @param couleur la nouvelle couleur de la caisse
     */
