...
public class Partie extends Observable implements Dessinable, Serializable {
     ...
     *            caisse à récupérer. On a besoin uniquement de la couleur de la
     *            caisse
     * @param caissePlateau
     *            caisse placée sur le plateau. On a besoin de connaître la
     *            position et la couleur de chaque caisse
     * @throws IllegalArgumentException
     *             <p>
     *             si le nombre de lignes est supérieur au nombre de lignes
     *             maximale,<br />
     *             si le nombre de colonnes est supérieur au nombre de colonnes
     *             maximal,<br />
     *             si les caissePlateau, robot, vortex ne contiennent pas de
