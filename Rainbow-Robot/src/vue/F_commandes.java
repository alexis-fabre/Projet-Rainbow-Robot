...
public class F_commandes extends JDialog implements ChangementLangue {
    ...
    public void setTextBt() {
        ...
        // mode
        System.out.println("isModeAbsolu = " + ToucheClavier.isModeAbsolu);
        System.out.println("tb absolu = " + Arrays.toString(ToucheClavier.TOUCHES_ABSOLU));
        System.out.println("tb relatif = " + Arrays.toString(ToucheClavier.TOUCHES_RELATIF));
