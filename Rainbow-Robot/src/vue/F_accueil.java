...
public class F_accueil extends JFrame implements ChangementLangue {
    ...
    /**
     * Bouton qui lance la fenêtre pour pouvoir changer les commandes
     */
    private JButton bt_Commande;
    ...
    public F_accueil(ClicSouris gestion) {
        ...
        super.setSize(UtilitaireFenetre.DIM_FENETRE_ACCUEIL);
        ...
        UtilitaireFenetre.addAComposantWithBoxLayout(getBt_Langue(),
                contentPane, 0, 40, Component.CENTER_ALIGNMENT);
        UtilitaireFenetre.addAComposantWithBoxLayout(getBt_Commande(),
                contentPane, 0, 40, Component.CENTER_ALIGNMENT);
        ...
        getBt_Commande().addMouseListener(gestion);
    ...
    public void setLangue() {
        ...
        getBt_Commande().setText(traductionAccueil[5]);
        getBt_Apropos().setText(traductionAccueil[6]);
        getBt_Quitter().setText(traductionAccueil[7]);
    }
    ...
    public JLabel getLa_titre() {
        if (la_titre == null) {
            la_titre = new JLabel();
            la_titre.setPreferredSize(UtilitaireFenetre.DIM_BOUTON_BAS_COMMANDE);
        }
        return la_titre;
    }
    ...
    /**
     * @return  bt_Commande bouton qui permet de lancer la fenêtre de 
     * modification des commandes
     */
    public JButton getBt_Commande() {
        if (bt_Commande == null) {
            bt_Commande = new JButton();
            // On définit une taille pour le bouton
            UtilitaireFenetre.setAllSize(bt_Commande,
                    UtilitaireFenetre.DIM_COMPOSANT_PRINCIPAL);
        }
        return bt_Commande;
    }
